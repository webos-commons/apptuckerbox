...
HelpAssistant.prototype.setup = function()
{
	...
	this.controller.get('appdetails').innerHTML = Mojo.appInfo.version + $L(' by AppTuckerbox.com');
	...
	this.supportModel.items.push({
		text: $L('Documentation (Wiki)'),
		detail: 'http://www.webos-internals.org/wiki/Application:AppTuckerbox',
		Class: 'img_web',
		type: 'web'
	});
	this.supportModel.items.push({
		text: $L('Announcements (Twitter)'),
		detail: 'http://twitter.com/apptuckerbox',
		Class: 'img_web',
		type: 'web'
	});
	this.supportModel.items.push({
