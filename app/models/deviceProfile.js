...
deviceProfile.prototype.getDeviceProfile = function(callback, reload)
{
    ...
    this.requestDeviceProfile = TuckerboxService.impersonate(this._gotDeviceProfile.bind(this),
...
deviceProfile.prototype.getDeviceId = function(callback, reload)
{
    ...
    this.requestDeviceId = TuckerboxService.impersonate(this._gotDeviceId.bind(this),
							  "com.palm.configurator",
							  "com.palm.deviceprofile",
							  "getDeviceId", {});
};
